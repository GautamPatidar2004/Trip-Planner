...
export const SignUp = ({ onNavigateToLogin }: any) => {
    ...
    >
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ flexGrow: 1 }}>
        ...
        <View style={styles.imageContainer}>
          <Image source={require('../../assets/trip_kerala.png')} style={styles.topImage} />
        ...
        <View style={styles.contentContainer}>
          ...
          <Text style={styles.subtitle}>Start your journey with AI Trip Planner</Text>
